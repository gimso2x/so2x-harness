...
| 변경 검토/마무리 | `/review`, `/review-cycle`, `/simplify-cycle`, `/safe-commit`, `/squash-commit` | 구현 후 리뷰, 반복 단순화, 커밋 전 검증, 최종 squash 정리 |
...
/simplify-cycle        # 반복 단순화 pass를 0까지 수렴
/safe-commit           # 커밋 전 검증
/squash-commit         # 검증 후 단일 squash 커밋 정리
